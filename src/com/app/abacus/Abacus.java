...
public class Abacus extends AbstractAbacus {
	...
	private String[] commands = { "AddRod", "MinusRod", "Wait", "HighlightFrame", "HighlightRods", 
			"HighlightBeam", "HighlightLowerBeads", "HighlightUpperBeads", "HighlightDots", "Reset", "Display" };
